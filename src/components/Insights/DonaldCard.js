...
import {ReactComponent as Donald} from "../../images/dangerous_donald.svg"
...
class ProfileCard extends Component {
    ...
    generateActivities = () => {
      return (
        <div>
        <List>
          <Listitem>Soirée dans un bar (3h, sans masque)</Listitem>
          <Listitem>Repas à 5 avec ses collègues (intérieur, sans masque) (x3)</Listitem>
          ...
          <Grid container spacing={1} justify="center" style={{height:"70"}}>
            ...
            <div className="svg_container">
                <svg style={{width:"100%", height:"100%",display:"block", margin:"auto"}}>
                  <Donald style={{display:"block", margin:"auto", height:"90%"}}/>
                </svg>
            </div>
            </Grid>
